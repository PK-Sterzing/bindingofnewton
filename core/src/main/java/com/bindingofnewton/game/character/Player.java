...
public class Player extends Entity {
    ...
    // Set this to true if we already wait once for the game over screen
    protected static boolean gameOverScreenTimerStarted = false;
    ...
    public void render(SpriteBatch batch, boolean isMoving) {
        ...
        if (isDead) {
            ...
            if(gameOverScreenTimerStarted == false){
                gameOverScreenTimerStarted = true;
