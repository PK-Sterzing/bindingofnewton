                ...
                switch (keycode){
                    case Input.Keys.UP:
                        shootBullet(Orientation.UP,
                                new Vector2((int) (posX + width / 2 - Bullet.WIDTH/2), (int) (posY + 20 + (height/2))));
                        break;
                    case Input.Keys.DOWN:
                        shootBullet(Orientation.DOWN,
                                new Vector2((int)( posX + width/2 - Bullet.WIDTH/2), (int)posY - 20));
                        break;
                    case Input.Keys.LEFT:
                        shootBullet(Orientation.LEFT,
                                new Vector2((int)posX - 20, (int) (posY + height/2)));
                        break;
                    case Input.Keys.RIGHT:
                        shootBullet(Orientation.RIGHT,
                                new Vector2((int) (posX + 20 + (width/ 2)), (int) (posY + height/ 2)));
                        break;
                }
            }
        }
